...
# 1. Agregamos la importación del nuevo módulo de evaluación
...
class ClinicalWindow(ctk.CTkToplevel):
    ...
    def _setup_sidebar(self):
        ...
        # 2. Agregamos el botón de Evaluación al menú lateral
        self._create_nav_btn("📊  Evaluación de Proceso", "evaluacion")
    ...
    def _setup_content_area(self):
        self.content_frame = ctk.CTkFrame(self, corner_radius=0, fg_color=("gray95", "gray15"))
    ...
    def show_module(self, module_name):
        ...
        # 3. Vinculamos el nombre del módulo con la clase del panel
        elif module_name == "evaluacion":
            EvaluationPanel(container, self.patient_id).pack(fill="both", expand=True)
